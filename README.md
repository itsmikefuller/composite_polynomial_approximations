...
All code snippets used to make the figures were written in $\text{MATLAB}$ and leveraged the [`chebfun`](https://www.chebfun.org/) package, allowing easy visualisation of polynomial approximants, their error functions, and their equioscillation points.
